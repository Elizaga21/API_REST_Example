...
public interface ProductoDao extends JpaRepository<Producto,Long> {
    ...
    /**
     * Vamos a necesitar tres métodos adiccionales a los que genera el CRUD Repository
     * (interface) para
     * 1. Recuperar la lista de productos ordenados
     * 2. Recuperar listado de productos paginados, es decir, que no traiga todos los productos, sino de 10 en 10,
     * 20 en 20, etc
     * 3. Recuperar las presentaciones con sus productos correspondientes sin tener que realizar una subconsulta que seria menos eficiente
     * que un join a las entidades utilizando HQL (Hibernate Query Language)
     *
